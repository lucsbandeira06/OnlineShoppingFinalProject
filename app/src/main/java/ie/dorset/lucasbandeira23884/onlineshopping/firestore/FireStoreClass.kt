package ie.dorset.lucasbandeira23884.onlineshopping.firestore
...
import ie.dorset.lucasbandeira23884.onlineshopping.ui.activities.*
import ie.dorset.lucasbandeira23884.onlineshopping.ui.fragments.DashboardFragment
...
//                activity.hideProgressDialog()
    ...
    fun getUserDetails(activity: Activity) {
        ...
        mFireStore.collection(Constants.USERS)
            ...
            .addOnSuccessListener { document ->
                ...
                // Key:Value logged_in_username: Current user
                editor.putString(
    ...
    fun updateUserProfileData(activity: Activity, userHashMap: HashMap<String, Any>) {
        ...
        mFireStore.collection(Constants.USERS)
            ...
            .document(getCurrentUserID())
            // updating hashmap created on userProfileActivity
            .update(userHashMap)
            .addOnSuccessListener {
    ...
    fun addAddress(activity: AddAddressListActivity, addressInfo: Address) {
